        ...
        */
        ...
        za = function (a, b) {
            ...
            for (var c = 0, d = 0, e = {}; d < a.length;) {
                var f = a[d++], g = _.xa(f) ? "o" + _.ya(f) : (typeof f).charAt(0) + f;
        ...
        w("Promise", function (a) {
            ...
            e.prototype.G = function (g) {
                if (g === this) this.o(new TypeError("h")); else if (g instanceof e) this.ia(g); else {
                    a:switch (typeof g) {
                        case "object":
                            var h = null != g;
                            break a;
            ...
            e.prototype.F = function () {
                if (this.A) return !1;
                var g = db.CustomEvent, h = db.Event,
                    l = db.dispatchEvent;
        ...
        w("String.prototype.startsWith", function (a) {
            return a ? a : function (b, c) {
                var d = ob(this, b, "startsWith"), e = d.length, f = b.length;
        ...
        var hc = !!(vb[0] & 512), ic = !!(vb[0] & 16), jc = !!(vb[0] & 1024), kc = !!(vb[0] & 8);
        var lc;
        lc = ub(1, !0);
        ...
        Kd.prototype.add = function (a, b, c, d, e) {
            ...
            a || (a = this.g[f] = [], this.h++);
            var g = Ld(a, b, d, e);
            -1 < g ? (b = a[g], c || (b.Vd = !1)) : (b = new Id(b, this.src, f, !!d, e), b.Vd = c, a.push(b));
            return b
        };
        ...
        Td = function (a, b, c, d, e, f) {
            if (!b) throw Error("C");
            var g = _.xa(e) ? !!e.capture : !!e, h = _.Ud(a);
            h || (a[Od] = h = new Kd(a));
            c = h.add(b, c, d, g, f);
            if (c.proxy) return c;
            d = Vd();
            ...
            d.src = a;
            d.listener = c;
            if (a.addEventListener) Cd || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e); else if (a.attachEvent) a.attachEvent(Wd(b.toString()), d); else if (a.addListener && a.removeListener) a.addListener(d); else throw Error("D");
            Qd++;
            return c
        };
        Vd = function () {
            var a = Xd, b = function (c) {
        ...
        _.Yd = function (a, b, c, d, e) {
            if (Array.isArray(b)) for (var f = 0; f < b.length; f++) _.Yd(a, b[f], c, d, e); else d = _.xa(d) ? !!d.capture : !!d, c = Sd(c), _.Gd(a) ? a.vb(b, c, d, e) : a && (a = _.Ud(a)) && (b = a.wd(b, c, d, e)) && _.Zd(b)
        };
        _.Zd = function (a) {
        ...
        _.k.dispatchEvent = function (a) {
            ...
            c = this.Oi;
            var d = a.type || a;
            if ("string" === typeof a) a = new _.Bd(a, c); else if (a instanceof _.Bd) a.target = a.target || c; else {
                var e = a;
                a = new _.Bd(d, c);
                Oa(a, e)
            }
        ...
        var me, ne = !1, oe = new ie, qe = function (a, b) {
            me || pe();
            ne || (me(), ne = !0);
            oe.add(a, b)
        }, pe = function () {
            ...
            if (0 == a.g) {
                ...
                a:{
                    ...
                    if (d instanceof _.ue) {
                        ...
                        var g = !0
                    } else if (se(d)) d.then(e, f, a), g = !0; else {
                        if (_.xa(d)) try {
                            var h = d.then;
        ...
        var Ce = function (a, b, c, d) {
            ...
            if (b.g) b.g.j = null, He(b, c, d); else try {
...
*/
        ...
        Je.prototype.cancel = function (a) {
            if (this.g) this.j instanceof Je && this.j.cancel(); else {
                if (this.h) {
                    var b = this.h;
                    delete this.h;
        ...
        yb.ab = Xe;
        yb.ab.g = {Cg: 0, qg: 1, TIMEOUT: 2, Ag: 3, Pe: 4};
        var Ze = function () {
            $b.call(this);
            this.g = {};
            this.l = [];
        ...
        _.k.Zf = function (a, b) {
            if (!(this instanceof Ze)) this.Zf(a, b); else if ("string" === typeof a) {
                a = a.split("/");
        ...
        _.vf = function (a, b) {
            ...
            } else if (a) if (a instanceof _.vf) for (c = a.vc(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d])); else for (d in a) this.set(d, a[d])
        };
        _.k = _.vf.prototype;
        _.k.zb = function () {
            return this.size
        ...
        _.k.Yb = function (a) {
            wf(this);
            var b = 0, c = this.j, d = this, e = new _.pf;
            e.next = function () {
        ...
        var Cf, Gf;
        Cf = function (a) {
            if (a.zb && "function" == typeof a.zb) a = a.zb(); else if (_.ea(a) || "string" === typeof a) a = a.length; else {
                var b = 0, c;
                for (c in a) b++;
                a = b
            }
        ...
        _.Ff = function (a, b, c) {
            if (a.forEach && "function" == typeof a.forEach) a.forEach(b, c); else if (_.ea(a) || "string" === typeof a) Array.prototype.forEach.call(a, b, c); else for (var d = _.Ef(a), e = _.Df(a), f = e.length, g = 0; g < f; g++) b.call(c, e[g], d && d[g], a)
        };
        Gf = function (a, b) {
            if ("function" == typeof a.every) return a.every(b, void 0);
            if (_.ea(a) || "string" === typeof a) return Array.prototype.every.call(a, b, void 0);
            for (var c = _.Ef(a), d = _.Df(a), e = d.length, f = 0; f < e; f++) if (!b.call(void 0, d[f], c && c[f], a)) return !1;
            return !0
        };
        var If;
        _.Hf = function (a) {
        ...
        var Jf = function (a, b) {
            ...
            return Gf(a, function (d) {
                var e = b;
                if (e.contains && "function" == typeof e.contains) d = e.contains(d); else if (e.pd && "function" == typeof e.pd) d = e.pd(d); else if (_.ea(e) || "string" === typeof e) d = _.u(e, d); else a:{
        ...
        new E("FENZqe");
        new E("tLnxq");
        Lf({g: [{id: _.bc, qc: de, multiple: !0}]});
        var Tf = {};
        var Uf = new Ad, Vf = function (a, b) {
            _.Bd.call(this, a, b);
            this.node = b
        };
        _.z(Vf, _.Bd);
        ...
        _.$f = function (a, b, c) {
            if (Array.isArray(b)) for (var d = 0; d < b.length; d++) _.$f(a, String(b[d]), c); else null != b && c.push(a + ("" === b ? "" : "=" + _.hd(b)))
        };
        ...
        _.ag.prototype.resolve = function (a) {
            var b = new _.ag(this), c = !!a.l;
            c ? _.bg(b, a.l) : c = !!a.A;
            c ? b.A = a.A : c = !!a.h;
            c ? _.cg(b, a.h) : c = null != a.B;
            var d = a.j;
            if (c) dg(b, a.B); else if (c = !!a.j) {
        ...
        _.k.Va = function (a) {
            sg(this);
            var b = [];
            if ("string" === typeof a) ug(this, a) && (b = b.concat(this.g.get(tg(this, a)))); else {
        ...
        var yg = "ARTICLE SECTION NAV ASIDE H1 H2 H3 H4 H5 H6 HEADER FOOTER ADDRESS P HR PRE BLOCKQUOTE OL UL LH LI DL DT DD FIGURE FIGCAPTION MAIN DIV EM STRONG SMALL S CITE Q DFN ABBR RUBY RB RT RTC RP DATA TIME CODE VAR SAMP KBD SUB SUP I B U MARK BDI BDO SPAN BR WBR INS DEL PICTURE PARAM TRACK MAP TABLE CAPTION COLGROUP COL TBODY THEAD TFOOT TR TD TH SELECT DATALIST OPTGROUP OPTION OUTPUT PROGRESS METER FIELDSET LEGEND DETAILS SUMMARY MENU DIALOG SLOT CANVAS FONT CENTER ACRONYM BASEFONT BIG DIR HGROUP STRIKE TT".split(" "),
            zg = [["A", new Map([["href", {Da: 2}]])], ["AREA", new Map([["href", {Da: 2}]])], ["LINK", new Map([["href", {
                Da: 2,
            ...
            }]])], ["SOURCE", new Map([["src", {Da: 1}]])], ["IMG", new Map([["src", {Da: 1}]])], ["VIDEO", new Map([["src", {Da: 1}]])], ["AUDIO", new Map([["src", {Da: 1}]])]],
            ...
            Bg = [["dir", {
                ...
                var d = new Set(["data-", "aria-"]), e = new Map(zg);
                this.j = a;
                this.g = e;
                this.l = b;
                this.o = c;
        ...
        Mg.prototype.toString = function () {
            if (this.h.endsWith("_/wa/")) var a = this.l ? this.h + Ng(this, "wk") + "/" + this.l : this.h + Ng(this, "wk") + ".wasm"; else {
                a = this.h + Og(this);
                var b = this.j;
                var c = [], d;
        ...
        var Pg = function (a) {
                ...
                var b = void 0 === b ? !0 : b;
                var c = Sg(a), d = new Mg, e = c.match(_.Xf)[5];
                _.Oc(Tg, function (g) {
                    var h = e.match("/" + g + "=([^/]+)");
                    h && Qg(d, g, h[1])
                });
                ...
                var b = a.lastIndexOf("_/wa/") + 5, c = a.indexOf("/", b);
        ...
        var Yg = function (a, b, c, d, e, f) {
            if (Array.isArray(c)) for (var g = 0; g < c.length; g++) Yg(a, b, c[g], d, e, f); else {
        ...
        _.I.prototype.vb = function (a, b, c, d, e) {
            if (Array.isArray(b)) for (var f = 0; f < b.length; f++) this.vb(a, b[f], c, d, e); else c = c || this.handleEvent, d = _.xa(d) ? !!d.capture : !!d, e = e || this.h || this, c = Sd(c), d = !!d, b = _.Gd(a) ? a.wd(b, c, d, e) : a ? (a = _.Ud(a)) ? a.wd(b, c, d, e) : null : null, b && (_.Zd(b), delete this.g[b.key]);
            return this
        };
        _.Zg = function (a) {
        ...
        _.k.send = function (a) {
            if (a) if ("string" == typeof a) this.g.send(a); else throw Error("V"); else this.g.send()
        };
        _.k.abort = function () {
            this.g.abort()
        };
        ...
        var rh = function (a) {
            if (a.h && "undefined" != typeof sb && (!a.F[1] || 4 != _.sh(a) || 2 != a.ib())) if (a.A && 4 == _.sh(a)) _.hh(a.V, 0, a); else if (a.dispatchEvent("readystatechange"), 4 == _.sh(a)) {
                a.h = !1;
                try {
        ...
        var wh = function (a, b, c, d, e) {
            ...
            if (a.B) a = _.td(document, "SCRIPT"), _.Ya(a,
                _.$a(d)), a.type = "text/javascript", a.async = !1, document.body.appendChild(a); else {
                var e = new Dh, f = new _.ih(0 < a.j.length ? new eh : void 0);
            ...
            if (e) c &&
            c(f); else if (g) d && d(); else for (a = 0; a < b.length; a++) d = b[a], Fh(d.o, d.Ya) || c && c(8001);
        ...
        var Ah = function (a, b, c, d) {
            ...
            var b = _.Yf(a.match(_.Xf)[5] || null) || "", c = _.Yf(Sg(b).match(_.Xf)[5] ||
                null);
        ...
        var Jh = new Kg(!1), Kh = document.location.href;
        Lf({
            h: {dml: Jh}, initialize: function (a) {
                var b = Jh.get(), c = "", d = "";
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.en_GB.bVrrHzcI_Bc.O/am=CAM/d=1/rs=AN8SPfrCykMZugH78Ds7teVZV3XNq-tFIg/m=el_conf
// Configure Constants
(function () {
    ...
    (function () {
        ...
        c._ps = 'https:\/\/www.gstatic.com\/_\/translate_http\/_\/ss\/k\x3dtranslate_http.tr.qhDXWpKopYk.L.W.O\/am\x3dCAM\/d\x3d0\/rs\x3dAN8SPfqeKn8wA30q4viup18yaci8udUjKQ\/m\x3del_main_css';
        c._plla = oph + '\/v1\/supportedLanguages';
        c._puh = 'translate.google.com';
        c._cnal = {};
        _loadCss(c._ps);
        _loadJs('https:\/\/translate.googleapis.com\/_\/translate_http\/_\/js\/k\x3dtranslate_http.tr.en_GB.bVrrHzcI_Bc.O\/d\x3d1\/exm\x3del_conf\/ed\x3d1\/rs\x3dAN8SPfrphYdH14BfDiS2I-_4kFKoDbr0iw\/m\x3del_main');
        _exportMessages();
        _exportVersion('TE_20231108');
    })();
})();

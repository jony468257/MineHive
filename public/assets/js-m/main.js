(function ($) {
    ...
    $.fn.mySelect = function (options) {
        ...
        let list = $("<ul />", { class: "select-options" }).insertAfter(
            styledSelect
        );
                ...
                colWidth = function () {
                    ...
                    $container.find(".cases-grid-item").each(function () {
                        var $item = $(this),
                            multiplier_w = $item
                                .attr("class")
                                .match(/cases-grid-item-w(\d)/),
                            multiplier_h = $item
                                .attr("class")
                                .match(/cases-grid-item-h(\d)/),
                            width = multiplier_w
    ...
    $(document).ready(function () {
        ...
        if ($(".xs-menus").length > 0) {
            $(".xs-menus").xs_nav({ mobileBreakpoint: 992 }, { passive: !0 });
        }
        ...
        if ($(".tab-swipe").length > 0) {
            ...
            $(".tab-swipe li a").on("click", function () {
                ...
                let cLeft =
                        $(".tab-swipe li a.isActive").position().left + "px",
        ...
        if ($(".testimonial-slider").length > 0) {
            $(".testimonial-slider").myOwl({ dots: !0 });
        }
        ...
        function chartInit() {
            for (let i = 0; i < $(".single-piechart").length; i++) {
                $(chart[i]).myChart({ barColor: barColors[i] });
            }
        }
        chart.each(function () {
            ...
            $(this)
                .find(".chart-content")
                .append('<span class="chart-value">' + value + "%</span>");
        });
        ...
        if ($(".product-slider, .about-slider").length > 0) {
            $(".product-slider, .about-slider").myOwl({ dots: !0 });
        }
        ...
        if ($(".rate-graph").length > 0) {
            $(".rate-graph").each(function () {
                if (
                    $(this).find(".rate-graph-bar").attr("data-percent") <= 100
                ) {
                    $(this)
                        .find(".rate-graph-bar")
                        .css({
